...
<body>
	<nav class="navbar navbar-expand-md bg-dark navbar-dark">
		<a class="navbar-brand" href="${root }">홈</a>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<c:choose>
				...
				<c:otherwise>
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link" href="${root }board/form">글쓰기</a></li>
						<li class="nav-item"><a class="nav-link" href="${root }user/form">회원정보</a></li>
